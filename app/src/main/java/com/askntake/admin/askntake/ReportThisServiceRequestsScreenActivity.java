...
import Adapters.ReportServiceRequestGridDisplyAdapter;
...
public class ReportThisServiceRequestsScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catogiry_filtering_grid.setAdapter(new ReportServiceRequestGridDisplyAdapter(this, mThumbIds));
        ...
        catogiry_filtering_grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                if (position < 5) {
                    ...
                    Intent myIntent = new Intent(ReportThisServiceRequestsScreenActivity.this, ReportingOtherTextActivity.class);
    ...
    private class HttpAsyncTaskGridClick extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String service_result = serviceHandler.makeServiceCall(AppConstants.REPORT_THIS_SERVICE_REQUEST_URL, "POST", requestObject);
    ...
    private JSONObject getJSONObject() {
        ...
        try {
            ...
            requestObject.accumulate("serviceRequestId", service_id);
