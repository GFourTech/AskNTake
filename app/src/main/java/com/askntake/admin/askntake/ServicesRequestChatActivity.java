...
import Fragments.ServicesProviderChatHistoryFragment;
import Fragments.ServicesRequesterChatHistoryFragment;

/**
 * Created by admin on 3/29/2017.
 */

public class ServicesRequestChatActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ServicesRequesterChatHistoryFragment(), "REQUESTER");
        adapter.addFragment(new ServicesProviderChatHistoryFragment(), "PROVIDER");
