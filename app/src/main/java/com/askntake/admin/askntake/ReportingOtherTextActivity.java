...
public class ReportingOtherTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent myIntent=new Intent(ReportingOtherTextActivity.this,ReportThisServiceScreenActivity.class);
