...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Location locationData = Commons.getLastKnownLocation(MapsActivity.this);
        latitudeOfMap = getIntent().getDoubleExtra("latitudeOfMap", 0);
        longitudeOfMap = getIntent().getDoubleExtra("longitudeOfMap", 0);
        // Initializing
        MarkerPoints = new ArrayList<>();
       // MarkerPoints.add(latLng = new LatLng(locationData.getLatitude(), locationData.getLongitude()));
        MarkerPoints.add(latLng = new LatLng(user_latitude, user_longitude));
        MarkerPoints.add(latLng = new LatLng(latitudeOfMap, longitudeOfMap));
