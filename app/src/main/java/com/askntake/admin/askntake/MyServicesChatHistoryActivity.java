...
import Fragments.ServiceUserChatHistoryFragment;
import Fragments.ServiceownerChatHistoryFragment;

/**
 * Created by admin on 3/29/2017.
 */

public class MyServicesChatHistoryActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ServiceownerChatHistoryFragment(), "PROVIDER");
        adapter.addFragment(new ServiceUserChatHistoryFragment(), "USER");
