...
public class MyServicesFragment extends Fragment {
    ...
    String user_id;
    TextView no_my_services_layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        no_my_services_layout = (TextView) root_view.findViewById(R.id.no_my_services_layout);
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (mainJsonObj.length() == 0) {
                        ...
                        no_my_services_layout.setVisibility(View.VISIBLE);
