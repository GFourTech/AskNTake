...
import com.askntake.admin.askntake.ServiceRequestsChatHistory;
...
public class ServicesRequesterChatHistoryFragment extends Fragment {
    ...
    private class PopulateOwnerHistorysAsynchTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            String response= serviceHandler.makeServiceCall(AppConstants.SERVICE_REQUESTER_USER_CHAT_HISTORY,"POST",getRequestObject());
            return response;
        }
        @Override
