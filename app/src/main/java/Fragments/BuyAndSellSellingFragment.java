...
public class BuyAndSellSellingFragment extends Fragment {
   ...
   List<ProductItemsPojo> productItemsListData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root_view = inflater.inflate(R.layout.fragment_buy_and_sell_selling, null);

        recycler_view_buy_and_sell_items = (RecyclerView) root_view.findViewById(R.id.recycler_view_buy_and_sell_items);
