...
public class ServicesUserChatHistoryFragment extends Fragment {
    ...
    private class PopulateOwnerHistorysAsynchTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            String response = serviceHandler.makeServiceCall(AppConstants.SERVICE_USER_CHAT_HISTORY, "POST", getRequestObject());
            return response;
        }
