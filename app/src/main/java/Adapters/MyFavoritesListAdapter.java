...
public class MyFavoritesListAdapter extends RecyclerView.Adapter<MyFavoritesListAdapter.MyViewHolder> {
    ...
    public MyFavoritesListAdapter(Context mContext, List<ItemServicePojo> albumList) {
        this.mContext = mContext;
        this.albumList = albumList;
    }

    @Override
    public MyFavoritesListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_view_myservices, parent, false);

        return new MyFavoritesListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final MyFavoritesListAdapter.MyViewHolder holder, int position) {
