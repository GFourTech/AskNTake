...
public class ServiceRequestChatHistoryAdapter extends ArrayAdapter<OwnerHistoryPojo> {

	private final Activity context;
	private final ArrayList<OwnerHistoryPojo> list;
	String showType;

	public ServiceRequestChatHistoryAdapter(Activity context, ArrayList<OwnerHistoryPojo> list, String showType) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			LayoutParams rlp=new LayoutParams(200* NavigationDrawerActivity.curScrenWidth/NavigationDrawerActivity.defaultScrenWidth,
